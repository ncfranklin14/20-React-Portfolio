...
export default function About() {
    ...
    return (
        <div className='aboutContainer'>
            ...
            <p className='par'>
            Full Stack web developer with a Full Stack Web Development Certificate from the University of Washington. I'm excited about pursuing a role in Full Stack or Frontend web development. My frontend skills include HTML5, CSS, jQuery, JavaScript, Bootstrap, ReactJS, and Handlebars. My backend skills include MySQL, MongoDB, Express, NodeJS, and Git. 
